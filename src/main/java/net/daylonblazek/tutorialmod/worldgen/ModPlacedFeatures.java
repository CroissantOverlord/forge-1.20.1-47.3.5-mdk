...
public class ModPlacedFeatures {
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> context) {
        ...
        register(context, AMBER_ORE_PLACED_KEY, configuredFeatures.getOrThrow(ModConfigureFeatures.OVERWORLD_AMBER_ORE_KEY),
                ModOrePlacement.commonOrePlacement(12,
                        HeightRangePlacement.uniform(VerticalAnchor.absolute(-7), VerticalAnchor.absolute(80))));
