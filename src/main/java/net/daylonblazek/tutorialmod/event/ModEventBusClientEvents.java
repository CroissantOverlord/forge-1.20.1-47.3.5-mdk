...
import net.daylonblazek.tutorialmod.entity.client.StegosaurusModel;
...
public class ModEventBusClientEvents {
    ...
    public static void registerLayer(EntityRenderersEvent.RegisterLayerDefinitions event) {
        ...
        event.registerLayerDefinition(ModModelLayers.STEGOSAURUS_LAYER, StegosaurusModel::createBodyLayer);
    }
